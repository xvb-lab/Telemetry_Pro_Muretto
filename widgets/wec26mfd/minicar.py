    ...
    def _brake_grad_color(self, t, car_class=""):
        ...
        if carbon:
            stops = [(40, (90, 95, 102)), (150, (90, 95, 102)),
                     (280, (80, 130, 200)), (360, (0, 180, 130)),
                     (520, (0, 230, 118)), (660, (200, 220, 40)),
                     (760, (255, 200, 0)), (850, (255, 120, 20)),
                     (950, (255, 50, 30)), (1060, (255, 235, 225))]
        else:
            stops = [(40, (90, 95, 102)), (120, (90, 95, 102)),
                     (240, (80, 130, 200)), (310, (0, 180, 130)),
                     (460, (0, 230, 118)), (610, (200, 220, 40)),
                     (710, (255, 200, 0)), (790, (255, 120, 20)),
                     (870, (255, 50, 30)), (960, (255, 235, 225))]
        if t <= stops[0][0]:
            r, g, b = stops[0][1]
            return QColor(r, g, b)
        if t >= stops[-1][0]:
