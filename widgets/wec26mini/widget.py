...
class Wec26MiniOverlay(WecOnboardOverlay):
    ...
    def paintEvent(self, e):
        ...
        f_h = QFont("Archivo SemiExpanded", 9)
        ...
        # velocita' KMH grande
        f_s = QFont("Archivo SemiExpanded", 30)
        ...
        f_g = QFont("Archivo SemiExpanded", 27)
        ...
        f_m = QFont("Archivo SemiExpanded", 13)
        ...
        if self._nrg is not None:
            f_l = QFont("Archivo SemiExpanded", 9)
            ...
            f_p = QFont("Archivo SemiExpanded", 17)
            f_p.setWeight(QFont.Black)
            f_p.setItalic(True)
            f_pp = QFont("Archivo SemiExpanded", 10)
